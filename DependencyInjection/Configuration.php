        ...
        $rootNode
            ->children()
                ...
                ->arrayNode('title')
                    ->children()
                        ->scalarNode('list')
                            ->info('The visible title displayed at the top of the list view')
                        ->end()
                        ->scalarNode('edit')
                            ->info('The visible title displayed at the top of the edit view')
                        ->end()
                        ->scalarNode('new')
                            ->info('The visible title displayed at the top of the new view')
                        ->end()
                        ->scalarNode('show')
                            ->info('The visible title displayed at the top of the show view')
                        ->end()
                    ->end()
                ->end()
