...
function createNullableControls(){var e=function(){var e=$(this);e.closest(".form-group").find("select").each(function(){var o=e.is(":checked");$(this).prop("disabled",o),o?$(this).parent().slideUp({duration:200}):$(this).parent().slideDown({duration:200})})};$(".nullable-control :checkbox").bind("change",e).each(e)}function toggleNavigation(e){var o="_easyadmin_navigation_iscollapsed";return function(){e?createPersistentCookie(o,!0):deleteCookie(o)}}function createPersistentCookie(e,o){document.cookie=encodeURIComponent(e)+"="+encodeURIComponent(o)+"; path=/; expires=Fri, 31 Dec 9999 23:59:59 GMT"}function deleteCookie(e){document.cookie=encodeURIComponent(e)+"=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT"}function createAutoCompleteFields(){var e=$("[data-easyadmin-autocomplete-url]");e.each(function(){var e=$(this).data("easyadmin-autocomplete-url");$(this).select2({theme:"bootstrap",ajax:{url:e,dataType:"json",delay:250,data:function(e){return{query:e.term}},cache:!0},placeholder:"",allowClear:!0,minimumInputLength:1})})}$(function(){var e=$("body");e.on("expanded.pushMenu",toggleNavigation(!1)).on("collapsed.pushMenu",toggleNavigation(!0)),createNullableControls(),createAutoCompleteFields()});
