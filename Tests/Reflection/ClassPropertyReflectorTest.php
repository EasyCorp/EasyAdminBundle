...
class ClassPropertyReflectorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function provideGetterValues()
    {
        return array(
            ...
            array('publicPropertyWithIsserWithoutHasserWithoutGetterWithoutSetter', 'isPublicPropertyWithIsserWithoutHasserWithoutGetterWithoutSetter'),
            array('protectedPropertyWithIsserWithoutHasserWithoutGetterWithoutSetter', 'isProtectedPropertyWithIsserWithoutHasserWithoutGetterWithoutSetter'),
            array('privatePropertyWithIsserWithoutHasserWithoutGetterWithoutSetter', 'isPrivatePropertyWithIsserWithoutHasserWithoutGetterWithoutSetter'),
            ...
            array('snake_case_public_property_with_hasser_without_getter_without_setter', 'hasSnakeCasePublicPropertyWithHasserWithoutGetterWithoutSetter'),
            array('snake_case_protected_property_with_hasser_without_getter_without_setter', 'hasSnakeCaseProtectedPropertyWithHasserWithoutGetterWithoutSetter'),
            array('snake_case_private_property_with_hasser_without_getter_without_setter', 'hasSnakeCasePrivatePropertyWithHasserWithoutGetterWithoutSetter'),
            array('snake_case_public_property_with_isser_without_hasser_without_getter_without_setter', 'isSnakeCasePublicPropertyWithIsserWithoutHasserWithoutGetterWithoutSetter'),
            array('snake_case_protected_property_with_isser_without_hasser_without_getter_without_setter', 'isSnakeCaseProtectedPropertyWithIsserWithoutHasserWithoutGetterWithoutSetter'),
            array('snake_case_private_property_with_isser_without_hasser_without_getter_without_setter', 'isSnakeCasePrivatePropertyWithIsserWithoutHasserWithoutGetterWithoutSetter'),
        );
    }
    ...
    public function provideSetterValues()
    {
        return array(
            ...
            array('publicPropertyWithIsserWithoutHasserWithoutGetterWithoutSetter', null),
            array('protectedPropertyWithIsserWithoutHasserWithoutGetterWithoutSetter', null),
            array('privatePropertyWithIsserWithoutHasserWithoutGetterWithoutSetter', null),
            array('snake_case_public_property_without_getter_without_setter', null),
            array('snake_case_protected_property_without_getter_without_setter', null),
            array('snake_case_private_property_without_getter_without_setter', null),
            ...
            array('snake_case_public_property_with_hasser_without_getter_without_setter', null),
            array('snake_case_protected_property_with_hasser_without_getter_without_setter', null),
            array('snake_case_private_property_with_hasser_without_getter_without_setter', null),
            array('snake_case_public_property_with_isser_without_hasser_without_getter_without_setter', null),
            array('snake_case_protected_property_with_isser_without_hasser_without_getter_without_setter', null),
            array('snake_case_private_property_with_isser_without_hasser_without_getter_without_setter', null),
        );
    }
    ...
    public function provideIsPublicValues()
    {
        return array(
            ...
            array('publicPropertyWithIsserWithoutHasserWithoutGetterWithoutSetter'),
            array('protectedPropertyWithIsserWithoutHasserWithoutGetterWithoutSetter'),
            array('privatePropertyWithIsserWithoutHasserWithoutGetterWithoutSetter'),
            ...
            array('snake_case_public_property_with_hasser_without_getter_without_setter'),
            array('snake_case_protected_property_with_hasser_without_getter_without_setter'),
            array('snake_case_private_property_with_hasser_without_getter_without_setter'),
            array('snake_case_public_property_with_isser_without_hasser_without_getter_without_setter'),
            array('snake_case_protected_property_with_isser_without_hasser_without_getter_without_setter'),
            array('snake_case_private_property_with_isser_without_hasser_without_getter_without_setter'),
        );
    }
}
