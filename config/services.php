...
return static function (ContainerConfigurator $container) {
    ...
    $services
        ...
        ->set(AdminRouterSubscriber::class)
            ...
            ->arg(9, new Reference('security.access_map', ContainerInterface::NULL_ON_INVALID_REFERENCE))
            ->arg(10, new Reference('security.authorization_checker', ContainerInterface::NULL_ON_INVALID_REFERENCE))
