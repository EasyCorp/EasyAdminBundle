...
If you create custom features in your backends, you may need to add links to
other CRUD actions. All URLs of EasyAdmin use the same route and the only differ
in the query string parameters. Instead of having to deal with that, you can use
the ``CrudUrlGenerator`` class in your PHP code::
...
The exact same features ara available in templates thanks to the
