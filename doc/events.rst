...
---------------------------------  ---------------------------------------------------  -------------------------------------------------------------------  ----------
``'ea.collection.item-added'``     Item added to collection                             ``{newElement: element, collection: collection}``                    false
---------------------------------  ---------------------------------------------------  -------------------------------------------------------------------  ----------
``'ea.collection.item-removed'``   Item removed from collection                         ``{deletedElement: element, collection: collection}``                false
---------------------------------  ---------------------------------------------------  -------------------------------------------------------------------  ----------
``'ea.autocomplete.pre-connect'``  Tomselect autocomplete field about to be connected   ``{config: config, prefix: 'autocomplete'}``                         false
---------------------------------  ---------------------------------------------------  -------------------------------------------------------------------  ----------
``'ea.autocomplete.connect'``      Tomselect autocomplete field connected               ``{tomSelect: tomSelect, config: config, prefix: 'autocomplete' }``  false
=================================  ===================================================  ===================================================================  ==========
