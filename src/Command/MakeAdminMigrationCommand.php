...
class MakeAdminMigrationCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $ea2Config = unserialize(file_get_contents($this->projectDir.'/easyadmin-config.backup'));
        $outputDir = $this->projectDir.'/src/Controller/Admin/Migration';
        $fs->mkdir($outputDir);
        ...
        foreach ($ea2Config['entities'] as $entityName => $entityConfig) {
            ...
            $code = CodeBuilder::new()
                ->_namespace('App\Controller\Admin\Migration')
            ...
            try {
                ...
                $fs->dumpFile($outputDir.'/'.$entityClassName.'CrudController.php', $formattedSourceCode);
            } catch (\Throwable $e) {
