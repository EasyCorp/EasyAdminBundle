            ...
            ->children()
                ...
                ->arrayNode('formats')
                    ...
                    ->children()
                        ...
                        ->end()
                        ->scalarNode('intl_date')
                            ->defaultNull()
                            ->info('The intl date format applied to "date" and "date_immutable" field types.')
                        ...
                        ->end()
                        ->scalarNode('intl_time')
                            ->defaultNull()
                            ->info('The intl date format applied to "time" and "time_immutable" field types.')
                            ->example('https://symfony.com/doc/master/bundles/EasyAdminBundle/book/list-search-show-configuration.html#formatting-dates-and-numbers')
                        ->end()
                        ->scalarNode('datetime')
                        ...
                        ->end()
                        ->enumNode('intl_number')
                            ->values(['decimal', 'percent', 'scientific', 'spellout', 'ordinal', 'duration'])
                            ->defaultNull()
                            ->info('The intl number format applied to numeric values.')
                            ->example('https://symfony.com/doc/master/bundles/EasyAdminBundle/book/list-search-show-configuration.html#formatting-dates-and-numbers')
                        ->end()
