            ...
            ->children()
                ...
                ->arrayNode('autocomplete')
                    ...
                    ->children()
                        ->integerNode('max_results')
                            ->defaultValue(10)
                            ->info('The maximum number of items displayed for autocomplete fields in the new/edit pages.')
                        ->end()
                    ->end()
                ->end()
                ...
                ->arrayNode('show')
                    ...
                    ->children()
                        ...
                        ->integerNode('max_results')
                            ->defaultValue(10)
                            ->info('The maximum number of items displayed for related fields in the show page.')
                        ->end()
                    ->end()
                ->end()
            ->end()
