...
final class Migrator
{
    ...
    private function getNewIconClass(?string $iconCssClass): string
    {
        ...
        $iconClassMap = [
            ...
            'fa-address-book-o' => 'fas fa-address-book',
            'fa-address-card-o' => 'fas fa-address-card',
            'fa-adn' => 'fab fa-adn',
            ...
            'fa-arrow-circle-o-down' => 'fas fa-arrow-alt-circle-down',
            'fa-arrow-circle-o-left' => 'fas fa-arrow-alt-circle-left',
            'fa-arrow-circle-o-right' => 'fas fa-arrow-alt-circle-right',
            'fa-arrow-circle-o-up' => 'fas fa-arrow-alt-circle-up',
            ...
            'fa-bar-chart' => 'fas fa-chart-bar',
            'fa-bar-chart-o' => 'fas fa-chart-bar',
            ...
            'fa-bell-o' => 'fas fa-bell',
            'fa-bell-slash-o' => 'fas fa-bell-slash',
            ...
            'fa-bookmark-o' => 'fas fa-bookmark',
            'fa-btc' => 'fab fa-btc',
            'fa-building-o' => 'fas fa-building',
            'fa-buysellads' => 'fab fa-buysellads',
            'fa-cab' => 'fas fa-taxi',
            'fa-calendar' => 'fas fa-calendar-alt',
            'fa-calendar-check-o' => 'fas fa-calendar-check',
            'fa-calendar-minus-o' => 'fas fa-calendar-minus',
            'fa-calendar-o' => 'fas fa-calendar',
            'fa-calendar-plus-o' => 'fas fa-calendar-plus',
            'fa-calendar-times-o' => 'fas fa-calendar-times',
            'fa-caret-square-o-down' => 'fas fa-caret-square-down',
            'fa-caret-square-o-left' => 'fas fa-caret-square-left',
            'fa-caret-square-o-right' => 'fas fa-caret-square-right',
            'fa-caret-square-o-up' => 'fas fa-caret-square-up',
            'fa-cc' => 'fas fa-closed-captioning',
            ...
            'fa-check-circle-o' => 'fas fa-check-circle',
            'fa-check-square-o' => 'fas fa-check-square',
            'fa-chrome' => 'fab fa-chrome',
            'fa-circle-o' => 'fas fa-circle',
            'fa-circle-o-notch' => 'fas fa-circle-notch',
            'fa-circle-thin' => 'fas fa-circle',
            'fa-clipboard' => 'fas fa-clipboard',
            'fa-clock-o' => 'fas fa-clock',
            ...
            'fa-comment-o' => 'fas fa-comment',
            'fa-commenting' => 'fas fa-comment-dots',
            'fa-commenting-o' => 'fas fa-comment-dots',
            'fa-comments-o' => 'fas fa-comments',
            ...
            'fa-diamond' => 'fas fa-gem',
            'fa-digg' => 'fab fa-digg',
            'fa-dollar' => 'fas fa-dollar-sign',
            'fa-dot-circle-o' => 'fas fa-dot-circle',
            'fa-dribbble' => 'fab fa-dribbble',
            'fa-drivers-license' => 'fas fa-id-card',
            'fa-drivers-license-o' => 'fas fa-id-card',
            'fa-dropbox' => 'fab fa-dropbox',
            'fa-drupal' => 'fab fa-drupal',
            'fa-edge' => 'fab fa-edge',
            'fa-eercast' => 'fab fa-sellcast',
            'fa-empire' => 'fab fa-empire',
            'fa-envelope-o' => 'fas fa-envelope',
            'fa-envelope-open-o' => 'fas fa-envelope-open',
            ...
            'fa-feed' => 'fas fa-rss',
            'fa-file-archive-o' => 'fas fa-file-archive',
            'fa-file-audio-o' => 'fas fa-file-audio',
            'fa-file-code-o' => 'fas fa-file-code',
            'fa-file-excel-o' => 'fas fa-file-excel',
            'fa-file-image-o' => 'fas fa-file-image',
            'fa-file-movie-o' => 'fas fa-file-video',
            'fa-file-o' => 'fas fa-file',
            'fa-file-pdf-o' => 'fas fa-file-pdf',
            'fa-file-photo-o' => 'fas fa-file-image',
            'fa-file-picture-o' => 'fas fa-file-image',
            'fa-file-powerpoint-o' => 'fas fa-file-powerpoint',
            'fa-file-sound-o' => 'fas fa-file-audio',
            'fa-file-text' => 'fas fa-file-alt',
            'fa-file-text-o' => 'fas fa-file-alt',
            'fa-file-video-o' => 'fas fa-file-video',
            'fa-file-word-o' => 'fas fa-file-word',
            'fa-file-zip-o' => 'fas fa-file-archive',
            'fa-files-o' => 'fas fa-copy',
            'fa-firefox' => 'fab fa-firefox',
            'fa-first-order' => 'fab fa-first-order',
            'fa-flag-o' => 'fas fa-flag',
            'fa-flash' => 'fas fa-bolt',
            'fa-flickr' => 'fab fa-flickr',
            'fa-floppy-o' => 'fas fa-save',
            'fa-folder-o' => 'fas fa-folder',
            'fa-folder-open-o' => 'fas fa-folder-open',
            ...
            'fa-frown-o' => 'fas fa-frown',
            'fa-futbol-o' => 'fas fa-futbol',
            ...
            'fa-hand-grab-o' => 'fas fa-hand-rock',
            'fa-hand-lizard-o' => 'fas fa-hand-lizard',
            'fa-hand-o-down' => 'fas fa-hand-point-down',
            'fa-hand-o-left' => 'fas fa-hand-point-left',
            'fa-hand-o-right' => 'fas fa-hand-point-right',
            'fa-hand-o-up' => 'fas fa-hand-point-up',
            'fa-hand-paper-o' => 'fas fa-hand-paper',
            'fa-hand-peace-o' => 'fas fa-hand-peace',
            'fa-hand-pointer-o' => 'fas fa-hand-pointer',
            'fa-hand-rock-o' => 'fas fa-hand-rock',
            'fa-hand-scissors-o' => 'fas fa-hand-scissors',
            'fa-hand-spock-o' => 'fas fa-hand-spock',
            'fa-hand-stop-o' => 'fas fa-hand-paper',
            'fa-handshake-o' => 'fas fa-handshake',
            'fa-hard-of-hearing' => 'fas fa-deaf',
            'fa-hdd-o' => 'fas fa-hdd',
            'fa-header' => 'fas fa-heading',
            'fa-heart-o' => 'fas fa-heart',
            'fa-hospital-o' => 'fas fa-hospital',
            'fa-hotel' => 'fas fa-bed',
            'fa-hourglass-1' => 'fas fa-hourglass-start',
            'fa-hourglass-2' => 'fas fa-hourglass-half',
            'fa-hourglass-3' => 'fas fa-hourglass-end',
            'fa-hourglass-o' => 'fas fa-hourglass',
            'fa-houzz' => 'fab fa-houzz',
            'fa-html5' => 'fab fa-html5',
            'fa-id-badge' => 'fas fa-id-badge',
            'fa-id-card-o' => 'fas fa-id-card',
            ...
            'fa-keyboard-o' => 'fas fa-keyboard',
            'fa-krw' => 'fas fa-won-sign',
            'fa-lastfm' => 'fab fa-lastfm',
            'fa-lastfm-square' => 'fab fa-lastfm-square',
            'fa-leanpub' => 'fab fa-leanpub',
            'fa-legal' => 'fas fa-gavel',
            'fa-lemon-o' => 'fas fa-lemon',
            ...
            'fa-lightbulb-o' => 'fas fa-lightbulb',
            ...
            'fa-meh-o' => 'fas fa-meh',
            'fa-minus-square-o' => 'fas fa-minus-square',
            'fa-mixcloud' => 'fab fa-mixcloud',
            'fa-mobile' => 'fas fa-mobile-alt',
            'fa-mobile-phone' => 'fas fa-mobile-alt',
            'fa-modx' => 'fab fa-modx',
            'fa-money' => 'fas fa-money-bill-alt',
            'fa-moon-o' => 'fas fa-moon',
            'fa-mortar-board' => 'fas fa-graduation-cap',
            'fa-navicon' => 'fas fa-bars',
            'fa-newspaper-o' => 'fas fa-newspaper',
            ...
            'fa-paper-plane-o' => 'fas fa-paper-plane',
            'fa-paste' => 'fas fa-clipboard',
            'fa-pause-circle-o' => 'fas fa-pause-circle',
            'fa-paypal' => 'fab fa-paypal',
            'fa-pencil' => 'fas fa-pencil-alt',
            'fa-pencil-square' => 'fas fa-pen-square',
            'fa-pencil-square-o' => 'fas fa-edit',
            'fa-photo' => 'fas fa-image',
            'fa-picture-o' => 'fas fa-image',
            ...
            'fa-play-circle-o' => 'fas fa-play-circle',
            'fa-plus-square-o' => 'fas fa-plus-square',
            'fa-product-hunt' => 'fab fa-product-hunt',
            'fa-qq' => 'fab fa-qq',
            'fa-question-circle-o' => 'fas fa-question-circle',
            ...
            'fa-send-o' => 'fas fa-paper-plane',
            'fa-share-square-o' => 'fas fa-share-square',
            ...
            'fa-smile-o' => 'fas fa-smile',
            'fa-snapchat' => 'fab fa-snapchat',
            'fa-snapchat-ghost' => 'fab fa-snapchat-ghost',
            'fa-snapchat-square' => 'fab fa-snapchat-square',
            'fa-snowflake-o' => 'fas fa-snowflake',
            'fa-soccer-ball-o' => 'fas fa-futbol',
            ...
            'fa-square-o' => 'fas fa-square',
            'fa-stack-exchange' => 'fab fa-stack-exchange',
            'fa-stack-overflow' => 'fab fa-stack-overflow',
            'fa-star-half-empty' => 'fas fa-star-half',
            'fa-star-half-full' => 'fas fa-star-half',
            'fa-star-half-o' => 'fas fa-star-half',
            'fa-star-o' => 'fas fa-star',
            'fa-steam' => 'fab fa-steam',
            'fa-steam-square' => 'fab fa-steam-square',
            'fa-sticky-note-o' => 'fas fa-sticky-note',
            'fa-stop-circle-o' => 'fas fa-stop-circle',
            ...
            'fa-thumbs-o-down' => 'fas fa-thumbs-down',
            'fa-thumbs-o-up' => 'fas fa-thumbs-up',
            'fa-ticket' => 'fas fa-ticket-alt',
            'fa-times-circle-o' => 'fas fa-times-circle',
            'fa-times-rectangle' => 'fas fa-window-close',
            'fa-times-rectangle-o' => 'fas fa-window-close',
            'fa-toggle-down' => 'fas fa-caret-square-down',
            'fa-toggle-left' => 'fas fa-caret-square-left',
            'fa-toggle-right' => 'fas fa-caret-square-right',
            'fa-toggle-up' => 'fas fa-caret-square-up',
            'fa-trash' => 'fas fa-trash-alt',
            'fa-trash-o' => 'fas fa-trash-alt',
            ...
            'fa-user-circle-o' => 'fas fa-user-circle',
            'fa-user-o' => 'fas fa-user',
            'fa-vcard' => 'fas fa-address-card',
            'fa-vcard-o' => 'fas fa-address-card',
            ...
            'fa-window-close-o' => 'fas fa-window-close',
