...
function createNullableControls(){var e=function(){var t=$(this);t.closest(".form-group").find("select").each(function(){var e=t.is(":checked");$(this).prop("disabled",e),e?$(this).parent().slideUp({duration:200}):$(this).parent().slideDown({duration:200})})};$(".nullable-control :checkbox").bind("change",e).each(e)}function toggleNavigation(e){var t="_easyadmin_navigation_iscollapsed";return function(){e?createPersistentCookie(t,!0):deleteCookie(t)}}function createPersistentCookie(e,t){document.cookie=encodeURIComponent(e)+"="+encodeURIComponent(t)+"; path=/; expires=Fri, 31 Dec 9999 23:59:59 GMT"}function deleteCookie(e){document.cookie=encodeURIComponent(e)+"=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT"}function createAutoCompleteFields(){$("[data-easyadmin-autocomplete-url]").each(function(){var e=$(this),t=e.data("easyadmin-autocomplete-url");e.select2({theme:"bootstrap",ajax:{url:t,dataType:"json",delay:250,data:function(e){return{query:e.term,page:e.page}},processResults:function(e,t){return{results:e.results,pagination:{more:e.has_next_page}}},cache:!0},placeholder:"",allowClear:!0,minimumInputLength:1})})}function showAdminPopup(e){var t=$(e).data("target"),n=$(e).data("action"),i=$(".easyadmin-entity-actions[data-uniqueid="+t+"]").attr("data-easyadmin-"+n+"-url");return window.open(i,t,"width=800,height=600,resizable=yes,scrollbars=yes").focus(),!1}function dismissAdminPopup(e,t,n,i){var a=e.name,o=$('.easyadmin-entity-actions[data-uniqueid="'+a+'"]');if(o.length&&"SELECT"===o[0].tagName)switch(t){case"new":o[0].options[o[0].options.length]=new Option(i,n,!0,!0),o.trigger("change");break;case"edit":o.find("option").each(function(){this.value==n&&(this.textContent=i)}),o.next().find(".select2-selection__rendered").each(function(){this.lastChild.textContent=i,this.title=i})}e.close()}$(function(){$("body").on("expanded.pushMenu",toggleNavigation(!1)).on("collapsed.pushMenu",toggleNavigation(!0)),createNullableControls(),createAutoCompleteFields(),$(document).on("easyadmin.collection.item-added",createAutoCompleteFields),$(document).on("click",".easyadmin-entity-new-btn, .easyadmin-entity-edit-btn",function(e){e.preventDefault(),showAdminPopup(this)}),$(document).on("change","select.easyadmin-entity-actions",function(e){var t=$(this),n=t.closest(".input-group").find(".easyadmin-entity-edit-btn"),i=t.attr("data-easyadmin-edit-url");i&&(t.attr("data-easyadmin-edit-url",i.replace(/(\?\w+=)\d+(&)/g,"$1"+(this.value||"0")+"$2")),this.value?n.removeClass("hide"):n.addClass("hide"))})}),window.showAdminPopup=showAdminPopup,window.dismissAdminPopup=dismissAdminPopup;
