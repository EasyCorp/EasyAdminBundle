...
class AdminAuthorizationChecker
{
     ...
     */
    public function isEasyAdminGranted(array $entityConfig, string $actionName, $subject = null): bool
    {
        try {
    ...
    private function getRequiredRole(array $entityConfig, string $actionName)
    {
