...
class FormViewTest extends AbstractTestCase
{
    ...
    public function testNewView()
    {
        ...
        $this->assertSame('Group Label 1', trim($crawler->filter('form fieldset legend')->eq(0)->text(null, true)));
        ...
        $this->assertSame('Section Label 1', trim($crawler->filter('form fieldset .form-section h2')->eq(0)->text(null, true)));
    ...
    public function testEditView()
    {
        ...
        $this->assertCount(1, $crawler->filter('form fieldset #product_name'));
        $this->assertSame('Edit Help', trim($crawler->filter('form fieldset input + .form-help')->eq(0)->text(null, true)));
