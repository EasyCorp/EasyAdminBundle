...
/**
 * CRUD controller for testing Crud::setEntityLabelInSingular().
 */
class SingularLabelTestCrudController extends AbstractCrudController
{
    ...
    {
        return $crud
            ->setEntityLabelInSingular('Custom Item');
    }
}
