...
/**
 * CRUD controller for testing Crud::setFormOptions().
 */
class FormOptionsTestCrudController extends AbstractCrudController
{
    ...
    {
        return $crud
            ->setFormOptions(['validation_groups' => ['Default']], ['validation_groups' => ['edit']]);
    }
}
