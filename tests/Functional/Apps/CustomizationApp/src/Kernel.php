...
namespace EasyCorp\Bundle\EasyAdminBundle\Tests\Functional\Apps\CustomizationApp;
...
final class Kernel extends SymfonyKernel
{
    ...
    {
        return sys_get_temp_dir().'/com.github.easycorp.easyadmin/tests/customizationapp/var/'.$this->environment.'/cache';
    }

    public function getLogDir(): string
    {
        return sys_get_temp_dir().'/com.github.easycorp.easyadmin/tests/customizationapp/var/'.$this->environment.'/log';
    }
