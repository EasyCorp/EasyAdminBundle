...
/**
 * CrudController for testing the ->setHelp() method of fields and how that
 * help message is rendered in the form.
 *
 * @extends AbstractCrudController<FormTestEntity>
 */
class FormFieldHelpSyntheticCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            TextField::new('description')->setHelp('Description Lorem Ipsum'),
            ...
            TextField::new('email')->setHelp('<a href="https://example.com">Email</a> <b>Lorem</b> Ipsum'),
            ...
            IntegerField::new('priority')->setHelp(t('<a href="https://example.com">Priority</a> <b>Lorem</b> Ipsum')),
        ];
    }
}
