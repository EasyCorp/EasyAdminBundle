...
/**
 * CRUD controller for testing custom search properties.
 * Only searches in searchableTextField and author.email fields (not searchableContentField).
 *
 * @extends AbstractCrudController<SearchTestEntity>
 */
class SearchCustomPropertiesCrudController extends AbstractCrudController
{
    ...
    public function configureCrud(Crud $crud): Crud
    {
        return parent::configureCrud($crud)
            ->setSearchFields(['searchableTextField', 'author.email']);
    }
