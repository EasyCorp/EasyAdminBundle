...
namespace EasyCorp\Bundle\EasyAdminBundle\Tests\Functional\Apps\DefaultApp;
...
final class Kernel extends SymfonyKernel
{
    ...
    {
        return sys_get_temp_dir().'/com.github.easycorp.easyadmin/tests/app/var/'.$this->environment.'/cache';
    }

    public function getLogDir(): string
    {
        return sys_get_temp_dir().'/com.github.easycorp.easyadmin/tests/app/var/'.$this->environment.'/log';
    }
