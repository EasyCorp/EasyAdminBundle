...
return static function (ContainerConfigurator $container) {
    ...
    $services->load('EasyCorp\\Bundle\\EasyAdminBundle\\Tests\\Functional\\Apps\\UglyUrlsApp\\', '../src/*')
        ->exclude('../{Entity,Tests,Kernel.php}');

    $services->load('EasyCorp\\Bundle\\EasyAdminBundle\\Tests\\Functional\\Apps\\UglyUrlsApp\\Controller\\', '../src/Controller/')
