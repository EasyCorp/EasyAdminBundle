...
namespace EasyCorp\Bundle\EasyAdminBundle\Tests\Functional\Apps\UglyUrlsApp;
...
final class Kernel extends SymfonyKernel
{
    ...
    {
        return sys_get_temp_dir().'/com.github.easycorp.easyadmin/tests/ugly_urls/var/'.$this->environment.'/cache';
    }

    public function getLogDir(): string
    {
        return sys_get_temp_dir().'/com.github.easycorp.easyadmin/tests/ugly_urls/var/'.$this->environment.'/log';
    }
