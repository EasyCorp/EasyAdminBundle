...
class FormFieldLabelController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            FormField::addTab()->setProperty('tab-1'),
            ...
            FormField::addTab(label: null)->setProperty('tab-2')->addCssClass('tab-2'),
            ...
            FormField::addTab(label: false)->setProperty('tab-3'),
            ...
            FormField::addTab(label: '')->setProperty('tab-4'),
            ...
            FormField::addTab('Tab 5')->setProperty('tab-tab-5'),
            ...
            FormField::addTab(t('Tab 6'))->setProperty('tab-tab-6'),
            ...
            FormField::addTab('<span class="text-danger">Tab</span> <b>7</b>')->setProperty('tab-tab-7'),
            ...
            // don't use <a> tags in the tab label because tabs are rendered inside <a> tags and that causes issues
            FormField::addTab(t('<span class="text-danger">Tab</span> <b>8</b>'))->setProperty('tab-tab-8'),
