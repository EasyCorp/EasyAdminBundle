...
namespace EasyCorp\Bundle\EasyAdminBundle\Tests\Unit\Intl;
...
class IntlFormatterTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // save the original locale to restore it in tearDown
        $this->originalLocale = \Locale::getDefault();

        // set a consistent locale for number formatting tests
        // this ensures tests pass regardless of the system's locale
