...
return [
    ...
    'exception' => [
        ...
        'general' => 'Παρουσιάστηκε σφάλμα κατά την επεξεργασία του αιτήματός σας.',
        'general_403' => 'Δεν έχετε δικαίωμα να εκτελέσετε αυτήν την ενέργεια.',
        'general_404' => 'Η σελίδα που ζητήθηκε δεν βρέθηκε.',
        'general_500' => 'Παρουσιάστηκε εσωτερικό σφάλμα κατά την επεξεργασία του αιτήματός σας.',
    ],
