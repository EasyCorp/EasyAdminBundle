...
return [
    ...
    'exception' => [
        ...
        'general' => 'При обработке вашего запроса произошла ошибка.',
        'general_403' => 'У вас недостаточно прав для выполнения этого действия.',
        'general_404' => 'Запрашиваемая страница не найдена.',
        'general_500' => 'При обработке вашего запроса произошла внутренняя ошибка.',
    ],
